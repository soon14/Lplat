...
public class UploadServlet extends HttpServlet {
     ...
     * @since JDK 1.6 
     */ 
    private static final long serialVersionUID = 4837205496392837349L;
        ...
        try {
            ...
            for (FileItem item : items) {
                if (!item.isFormField()) {
                		...
                		String fileId = FileUtil.saveFile(item.get(),item.getName(), getSuffix(item.getName()));
