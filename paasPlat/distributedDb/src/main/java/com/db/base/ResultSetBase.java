...
public abstract class ResultSetBase implements ResultSet {
	...
	public short getShort(int columnIndex) throws SQLException {
		...
		if(BigDecimal.class.isAssignableFrom(lastColumnValue.getClass())){
		    
		    return Short.valueOf(((BigDecimal)lastColumnValue).shortValue());
		}
	...
	public int getInt(int columnIndex) throws SQLException {
		...
		if(BigDecimal.class.isAssignableFrom(lastColumnValue.getClass())){
            ...
            return Integer.valueOf(((BigDecimal)lastColumnValue).intValue());
        }
	...
	public long getLong(int columnIndex) throws SQLException {
		...
		if(BigDecimal.class.isAssignableFrom(lastColumnValue.getClass())){
            ...
            return Long.valueOf(((BigDecimal)lastColumnValue).longValue());
        }
	...
	public float getFloat(int columnIndex) throws SQLException {
		...
		if(BigDecimal.class.isAssignableFrom(lastColumnValue.getClass())){
            ...
            return Float.valueOf(((BigDecimal)lastColumnValue).floatValue());
        }
	...
	public double getDouble(int columnIndex) throws SQLException {
		...
		if(BigDecimal.class.isAssignableFrom(lastColumnValue.getClass())){
            ...
            return Double.valueOf(((BigDecimal)lastColumnValue).doubleValue());
        }
	...
	public void close() throws SQLException {
		...
		for(ResultSet rs : sets) {
			try {
				...
				logger.warn("close db result set ex:", e);
			}
		}
//		sets.clear();
		for (Statement stmt : stmtList) {
			try {
				...
				logger.warn("close db statement ex:", e);
			}
//			stmtList.clear();
		}
		closed = true;
