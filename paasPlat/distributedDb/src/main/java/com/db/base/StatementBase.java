...
import com.db.distribute.SqlExecPlan;
...
public abstract class StatementBase implements Statement {
	...
	protected List<Statement> dbStmtList;
	...
	protected Statement realSmt=null;
	...
	public ResultSet executeQuery(String sql, int flag) throws SQLException {
		if(this.isClosed()) {
			return null;
		}
		processDbRule(sql);
...
//		}
//		return getResultSet();
		return executeQuery(sql, Constants.NORMAL_DB_FLAG);
