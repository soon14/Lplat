...
import com.db.sql.parser.SQLParser.Aggregate_functionContext;
import com.db.sql.parser.SQLParser.Alter_table_statementContext;
import com.db.sql.parser.SQLParser.Column_name_listContext;
import com.db.sql.parser.SQLParser.Comp_opContext;
import com.db.sql.parser.SQLParser.Comparison_predicateContext;
import com.db.sql.parser.SQLParser.Create_table_statementContext;
import com.db.sql.parser.SQLParser.Derived_tableContext;
import com.db.sql.parser.SQLParser.Drop_table_statementContext;
import com.db.sql.parser.SQLParser.General_set_functionContext;
import com.db.sql.parser.SQLParser.Groupby_clauseContext;
import com.db.sql.parser.SQLParser.Grouping_elementContext;
import com.db.sql.parser.SQLParser.Grouping_element_listContext;
import com.db.sql.parser.SQLParser.Having_clauseContext;
import com.db.sql.parser.SQLParser.IdentifierContext;
import com.db.sql.parser.SQLParser.In_predicateContext;
import com.db.sql.parser.SQLParser.In_predicate_valueContext;
import com.db.sql.parser.SQLParser.In_value_listContext;
import com.db.sql.parser.SQLParser.Numeric_value_expressionContext;
import com.db.sql.parser.SQLParser.Pattern_matcherContext;
import com.db.sql.parser.SQLParser.Pattern_matching_predicateContext;
import com.db.sql.parser.SQLParser.Row_value_predicandContext;
import com.db.sql.parser.SQLParser.Set_function_typeContext;
import com.db.sql.parser.SQLParser.Table_nameContext;
import com.db.sql.parser.SQLParser.Table_or_query_nameContext;
import com.db.sql.parser.SQLParser.Table_primaryContext;
import com.db.sql.parser.SQLParser.Table_subqueryContext;
...
//        String sql = "select * from (select t_1.*,rownum as row_num from (select log_id, log_info, db_code from t_demo_log  where (  db_code like question_mark_1 and log_info is not null )  ) t_1 where rownum<=2 + 3) t_2 where t_2.row_num>2";
        ...
        String sql="select count(db_code) total from(select t.db_code,count(t.db_code) total from t_demo_log_01 t where t.log_id<100 group by t.db_code) tt";
