...
public class TransactionContext implements Serializable {
	...
	public static final Integer ABNORMAL_RANSACTION_STATUS_ALL_STOP = 40;//等于最大发送次数后的状态，停止发送
	...
	private Integer maxSendTimes; //最大发送次数
	private Integer intervalTime;//重试间隔时间(s)
