...
public class CipherUtil {
	...
	public static final String SECURITY_KEY = "92ba640738a413b0";//"04daa44fa2865815";
	...
	public static void main(String[] args) {
		...
		String aa1 = encrypt("ecpim123");
		System.out.println("====< "+aa1+" >");
		System.out.println(new String(decrypt("dbfc229164e44c9fa61403462f3f23c6")));
	}
}
